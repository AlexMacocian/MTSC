...
namespace MTSC.Common.WebSockets.ServerModules
{
    public interface IWebsocketModule
    {
        ...
        void ConnectionInitialized(ServerSide.Server server, WebsocketHandler handler, ClientData client);
        /// <summary>
        ...
        bool HandleReceivedMessage(ServerSide.Server server, WebsocketHandler handler, ClientData client, WebsocketMessage receivedMessage);
        /// <summary>
        ...
        /// <param name="handler">Handler currently processing.</param>
        /// <param name="client">Client object.</param>
        void ConnectionClosed(ServerSide.Server server, WebsocketHandler handler, ClientData client);
    }
}
